...
people_records = list(people_records)

people_records.insert(0, ('Anna', 'Pustovaya', 27, 'QA', 'Odessa'))
...
for i in [6, 10, 13]:
    ages_to_check.append(people_records[i][2])

all_ages_above_30 = True
for age in ages_to_check:
    if age < 30:
        all_ages_above_30 = False
        break

print(all_ages_above_30)


people_records = tuple(people_records)
